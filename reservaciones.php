         ...
         <div class="campo">
                ...
                <input type="text" id="apellido" name="apellido" placeholder="tu apellido">
                    ...
                    <label for="email">Email:</label>
                        <input type="email" id="email" name="email" placeholder="poi@iyr.com">
                        </div>
           <div id="error"> </div>
                    </div>
            <div id="paquetes" class="paquetes">
               <h3>Elige el numero der boletos</h3>
                ...
                <div class="tabla-precio">
                  ...
                  <label for="pase_dia" >Cuantos boletos </label>
                ...
                <div class="tabla-precio">
                    ...
                    <label for="pase_completo" >Cuantos boletos </label>
                ...
                <div class="tabla-precio">
                   ...
                   <label for="pase_dosdias" >Cuantos boletos </label>
                 ...
                 <div class="orden">
                    <label for="camisa_evento"> Camisa del evento $10 <small>(promocion 7% descuento)</small></label>
                     <input type="number" min="0" id="camisa_evento" size="3" placeholder="0">
                      ...
                      <div class="orden">
                    <label for="etiquetas"> Paquete de 10 estampas $2 <small>(HTML, CSS3)</small></label>
